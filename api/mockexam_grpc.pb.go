...
type IncrementServiceClient interface {
	Increment(ctx context.Context, in *IncrementMsg, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *incrementServiceClient) Increment(ctx context.Context, in *IncrementMsg, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type IncrementServiceServer interface {
	Increment(context.Context, *IncrementMsg) (*Response, error)
...
func (UnimplementedIncrementServiceServer) Increment(context.Context, *IncrementMsg) (*Response, error) {
...
func _IncrementService_Increment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IncrementServiceServer).Increment(ctx, req.(*IncrementMsg))
	}
